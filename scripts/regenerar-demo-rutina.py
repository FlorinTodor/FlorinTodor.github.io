...
TRADUCCION += [
    ...
    ("pesajes</b> que abarquen", "weigh-ins</b> spanning"),
    ("días</b> dentro de los últimos", "days</b> within the last"),
    ("; ahora hay", "; right now there are"),
    ('en ${e.dias} ${e.dias === 1 ? "día" : "días"}.',
     'over ${e.dias} ${e.dias === 1 ? "day" : "days"}.'),
    ("Pésate en ayunas tres o cuatro días por semana y esto se llena solo.",
     "Weigh in fasted three or four days a week and this fills itself in."),
    # la otra carencia: pesajes sobran y lo que falta es recorrido
    ("Pesajes hay de sobra (<b>${e.pesajes}</b>): lo que falta es",
     "There are plenty of weigh-ins (<b>${e.pesajes}</b>): what is missing is"),
    ("<b>recorrido</b>. Del primero al último tienen que pasar",
     "<b>span</b>. The first and the last have to be"),
    ("días</b> para que la pendiente sea grasa y no el agua",
     "days</b> apart so the slope is fat and not the water"),
    ("de la semana, y de momento abarcan ${e.dias}.",
     "of the week, and right now they span ${e.dias}."),
    (" Si sigues pesándote, esto se llena el <b>",
     " If you keep weighing yourself, this fills in on <b>"),

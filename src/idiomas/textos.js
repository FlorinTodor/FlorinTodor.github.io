...
export const TEXTOS = {
  es: {
    ...
    tarjeta: {
      ...
      insigniaPrototipo: 'prototipo',
      cartelAlt: (titulo) => `Captura de la demo de ${titulo}`,
      cartelPrototipoAlt: (titulo) => `Captura del prototipo de ${titulo}`,
    ...
    ficha: {
      ...
      verPrototipo: 'Abrir el prototipo ↗',
      tituloPrototipo: 'El prototipo',
      introPrototipo: 'Capturas del prototipo de alta fidelidad. El navegable está detrás del botón de arriba.',
      capturasAlt: (titulo) => `Capturas del prototipo de ${titulo}`,
      verDemo: '▶ Ver la demo',
    ...
    blog: {
      ...
      altOg: (titulo) => `${titulo} - artículo de ${NOMBRE}`,
  ...
  en: {
    ...
    tarjeta: {
      ...
      insigniaPrototipo: 'prototype',
      cartelAlt: (titulo) => `Screenshot of the ${titulo} demo`,
      cartelPrototipoAlt: (titulo) => `Screenshot of the ${titulo} prototype`,
    ...
    ficha: {
      ...
      verPrototipo: 'Open the prototype ↗',
      tituloPrototipo: 'The prototype',
      introPrototipo: 'Screenshots of the high-fidelity prototype. The navigable one is behind the button above.',
      capturasAlt: (titulo) => `Screenshots of the ${titulo} prototype`,
    ...
    blog: {
      ...
      minutos: (min) => `${min} min`,
      volver: '← All posts',
      altOg: (titulo) => `${titulo} - a post by ${NOMBRE}`,
